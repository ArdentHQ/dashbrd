...
describe("useGalleryNftsContext", () => {
    ...
    //
    //     await waitFor(() => {
    //         expect(container.getElementsByClassName("TestGallery_Collection").length).toBe(1);
    //     });
    //
    //     expect(container.getElementsByClassName("TestGallery_NFT").length).toBe(2);
    //
    //     server.use(
    //         requestMockOnce(`${BASE_URL}/my-galleries/collections`, {
    //             nfts: [...newNfts1, ...newNfts2],
    //             collections: {
    //                 paginated: {
    //                     data: [],
    //                     links: SamplePageMeta.paginated.links,
