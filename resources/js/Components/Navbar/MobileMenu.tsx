    ...
    return (
        <>
            <IconButton
                ...
                baseClassName="md-lg:hidden mr-3 border-white xs:border-theme-secondary-300 w-auto xs:w-10 hover:bg-transparent xs:hover:bg-theme-secondary-300 dark:hover:bg-transparent xs:dark:hover:bg-theme-dark-700 border-0 sm:border"
            />
            <Slider
                isOpen={isMenuOpen}
                isFullScreen={true}
