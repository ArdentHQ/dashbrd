...
export const MobileButton = ({ page, totalPages, ...properties }: MobileButtonProperties): JSX.Element => {
    ...
    return (
        <button
            type="button"
            className="transition-default flex w-full items-center justify-center space-x-4 rounded-full border border-theme-secondary-300 px-5 py-2 text-theme-secondary-700 hover:bg-theme-secondary-300"
