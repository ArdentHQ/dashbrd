                ...
                >
                    <div className="flex items-center space-x-2 text-lg font-medium">
                        <span className="text-theme-secondary-900 dark:text-theme-dark-50">
                            {t("pages.transaction_details_panel.title")}
                        </span>
                    </div>
                </div>
            </Slider.Header>
            ...
            {transaction !== undefined && (
                <Slider.Content>
                    <div data-testid="TokenTransactionDetailsSlider__content">
                        ...
                        {/* Amount Fiat/Crypto */}
                        <div className="mt-3 flex justify-between rounded-xl border border-theme-secondary-300 bg-theme-secondary-50 px-6 py-4 dark:border-theme-dark-700 dark:bg-theme-dark-950">
                            <div className="flex flex-col">
                                <span className="text-sm font-medium text-theme-secondary-500 dark:text-theme-dark-400">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    >
                                        <Icon
                                            name="Copy"
                                            size="md"
                                            className="cursor-pointer text-theme-primary-600 dark:text-theme-primary-400 dark:hover:text-theme-primary-500"
                                        />
                                    </Clipboard>
                                </div>
                            </DetailItem>
