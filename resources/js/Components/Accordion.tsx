...
export const AccordionItem = ({ title, children }: AccordionItemProperties): JSX.Element => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="transition-default mx-2 my-1.5 flex min-w-0 items-center rounded-xl p-2 group-hover:bg-theme-secondary-100 sm:mx-3 sm:p-3">
                    ...
                    <div className="ml-2 flex h-6 w-6 items-center justify-center">
                        <Icon
                            ...
                            size="sm"
                            className={cn("transform text-theme-secondary-900 transition duration-100", {
                                "rotate-180": isOpen,
                            })}
                        />
                    </div>
...
export const Accordion = ({ children }: { children: React.ReactNode }): JSX.Element => (
    <div
        ...
        className="divide-y divide-theme-secondary-300 rounded-xl border border-theme-secondary-300 py-2"
    >
        {children}
    </div>
);
