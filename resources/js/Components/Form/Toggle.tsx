        ...
        <Switch
            ...
            className={cn(
                ...
                disabled
                    ...
                    : [
                          checked
                              ? "bg-theme-primary-600 hover:bg-theme-primary-700 active:bg-theme-primary-800 dark:bg-theme-primary-400 dark:hover:bg-theme-primary-600 dark:focus-visible:bg-theme-primary-400 dark:active:bg-theme-primary-400"
