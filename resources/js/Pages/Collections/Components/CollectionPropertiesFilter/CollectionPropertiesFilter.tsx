...
export const CollectionPropertiesFilter = ({
    ...
    return (
        <div className="flex flex-col overflow-hidden border-y border-theme-secondary-300 dark:border-theme-dark-700 lg:sticky lg:top-4 lg:max-h-screen xs:rounded-xl xs:border">
