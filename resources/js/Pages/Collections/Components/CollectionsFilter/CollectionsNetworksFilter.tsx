...
console.log({availableNetworks})
    return (
        <div className="flex flex-col overflow-hidden rounded-xl bg-white shadow-xl lg:max-h-screen dark:bg-theme-dark-900 dark:border dark:border-theme-dark-700">
