    ...
    return (
        <div className="flex flex-col items-center space-y-6 ">
            ...
            {nfts.paginated.meta.total >= 12 && (
                <div className="flex w-full flex-col items-center justify-between space-x-3 space-y-3 rounded-b border-theme-secondary-300 xs:w-auto sm:space-y-0 md:w-full md:flex-row">
                    <SelectPageLimit
                        value={pageLimit}
                        options={[12, 24, 48, 96]}
                        onChange={({ value }) => {
