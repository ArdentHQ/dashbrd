...
export type ImagesData = {/** 96x96 */ thumb:string | null;/** 256x256 */ small:string | null;/** 512x512 */ large:string | null;};
export type NetworkData = {name:string;chainId:number;isMainnet:boolean;publicRpcProvider:string;explorerUrl:string;};
...
export type CollectionTraitData = {displayType:string;name:string;/** Use the displayType to infer the actual type. */ value:string | number;/** Only present for numeric displayTypes. */ valueMin:?number;/** Only present for numeric displayTypes. */ valueMax:?number;nftsCount:number;nftsPercentage:number;};
...
paginated: {data:Array<App.Data.Gallery.GalleryData>;links:Array<{url:string | null;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number | null;last_page:number;last_page_url:string;next_page_url:string | null;path:string;per_page:number;prev_page_url:string | null;to:number | null;total:number;};};
};
...
paginated: {data:Array<App.Data.Gallery.GalleryCollectionData>;links:Array<{url:string | null;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number | null;last_page:number;last_page_url:string;next_page_url:string | null;path:string;per_page:number;prev_page_url:string | null;to:number | null;total:number;};};
};
...
paginated: {data:Array<App.Data.Gallery.GalleryNftData>;links:Array<{url:string | null;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number | null;last_page:number;last_page_url:string;next_page_url:string | null;path:string;per_page:number;prev_page_url:string | null;to:number | null;total:number;};};
};
...
paginated: {data:Array<App.Data.Nfts.NftActivityData>;links:Array<{url:string | null;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number | null;last_page:number;last_page_url:string;next_page_url:string | null;path:string;per_page:number;prev_page_url:string | null;to:number | null;total:number;};};
};
...
export type NftImagesData = {/** 96x96 */ thumb:string | null;/** 256x256 */ small:string | null;/** 512x512 */ large:string | null;original:string|null;originalRaw:string|null;};
...
paginated: {data:Array<App.Data.Token.TokenPriceData>;links:Array<{url:string | null;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number | null;last_page:number;last_page_url:string;next_page_url:string | null;path:string;per_page:number;prev_page_url:string | null;to:number | null;total:number;};};
};
}
...
export type WalletData = {address:string;domain:string | null;avatar:WalletAvatarData;totalUsd:number;totalBalanceInCurrency:string;totalTokens:number;nfts:WalletNftData[];nftCount:number;collectionCount:number;collectionsValue:number | null;galleryCount:number;timestamps:{tokens_fetched_at: number|null, native_balances_fetched_at: number|null};};
