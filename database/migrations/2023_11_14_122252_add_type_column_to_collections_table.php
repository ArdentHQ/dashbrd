...
return new class extends Migration
{
    ...
    private function erc1155Addresses(string $network): Collection
    {
        ...
        // It's possible this file does not exist in situations like GitHub Actions (or production),
        // so we hardcode the list of addresses taken from the file...
        $addresses = $network === 'eth' ? collect([
        ...
        if (file_exists($path)) {
            ...
            $addresses->merge(
                collect(json_decode($contents, true)['data'])
